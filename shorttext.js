...
class Shorttext {
       ...
       static _callbackCut(event, maxCharacter, options) {
           ...
           event.clipboardData.setData('text/plain', Shorttext._traitText(textSelected, maxCharacter, options));
       };
        ...
        * @param {String} text 
        */
       static _traitText(text, maxCharacter, options) {
           // se a quantidade de caracteres selecionada for menor o permitido, retorna o texto sem o link
